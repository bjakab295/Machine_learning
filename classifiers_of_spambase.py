...
y = data[:,57];
#del data;
input_names = breast_cancer.feature_names
...
logreg_classifier.fit(X_train_bc,y_train_bc);
score_train_logreg = logreg_classifier.score(X_train_bc,y_train_bc);
score_test_logreg = logreg_classifier.score(X_test_bc,y_test_bc);  #  goodness of fit
ypred_logreg = logreg_classifier.predict(X_test_bc);   # spam prediction
yprobab_logreg = logreg_classifier.predict_proba(X_test_bc);  #  prediction probabilities

# Fitting naive Bayes classifier
naive_bayes_classifier = GaussianNB();
naive_bayes_classifier.fit(X_train_bc,y_train_bc);
score_train_naive_bayes = naive_bayes_classifier.score(X_train_bc,y_train_bc);  #  goodness of fit
score_test_naive_bayes = naive_bayes_classifier.score(X_test_bc,y_test_bc);  #  goodness of fit
ypred_naive_bayes = naive_bayes_classifier.predict(X_test_bc);  # spam prediction
yprobab_naive_bayes = naive_bayes_classifier.predict_proba(X_test_bc);  #  prediction probabilities

# Fitting nearest neighbor classifier
K = 5;  # number of neighbors
knn_classifier = KNeighborsClassifier(n_neighbors=K);
knn_classifier.fit(X_train_bc,y_train_bc);
score_train_knn = knn_classifier.score(X_train_bc,y_train_bc);  #  goodness of fit
score_test_knn = knn_classifier.score(X_test_bc,y_test_bc);  #  goodness of fit
ypred_knn = knn_classifier.predict(X_test_bc);   # spam prediction
yprobab_knn = knn_classifier.predict_proba(X_test_bc);  #  prediction probabilities

# Fitting neural network classifier
neural_classifier = MLPClassifier(hidden_layer_sizes=(3),activation='logistic',max_iter=5000);  #  number of hidden neurons: 5
neural_classifier.fit(X_train_bc,y_train_bc);
score_train_neural = neural_classifier.score(X_train_bc,y_train_bc);  #  goodness of fit
score_test_neural = neural_classifier.score(X_test_bc,y_test_bc);  #  goodness of fit
ypred_neural = neural_classifier.predict(X_test_bc);   # spam prediction
yprobab_neural = neural_classifier.predict_proba(X_test_bc);  #  prediction probabilities
...
# Default axis
x_axis = 13;  # x axis attribute (0..56)
y_axis = 15;  # y axis attribute (0..56)
...
plt.scatter(X_test_bc[:,x_axis],X_test_bc[:,y_axis],s=100*yprobab_neural[:,0],
